...
COLORS = {
    'bg_primary': (8, 13, 22),
    'bg_secondary': (18, 27, 39),
    'bg_elevated': (36, 45, 58),
    'surface': (28, 38, 52),
    'surface_warm': (62, 42, 52),
    'accent': (34, 196, 170),
    'accent_warm': (248, 181, 72),
    'accent_family': (242, 86, 124),
    'accent_cool': (78, 139, 232),
    'text_primary': (250, 253, 255),
    'text_secondary': (211, 221, 230),
    'text_muted': (132, 146, 162),
    'rail': (11, 13, 19),
    'rail_edge': (82, 99, 116),
    'stop': (255, 61, 82),
    'error': (255, 81, 93),
